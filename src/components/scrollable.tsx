...
export const DEFAULT_RECAP_ITEMS: ScrollItem[] = [
  {
    id: 'item-1',
    image: '/images/recap-images/Speaker frame.png',
    label: 'DevFest Attendees with Sunglasses',
  },
  {
    id: 'item-2',
    image: '/images/recap-images/Speaker frame-1.png',
    label: '3000+ Attendees Card',
  },
  {
    id: 'item-3',
    image: '/images/recap-images/Speaker frame-2.png',
    label: 'Main Stage Draped Hall',
  },
  {
    id: 'item-4',
    image: '/images/recap-images/Speaker frame (1).png',
    label: 'Innovation Hub Stage Presentation',
  },
  {
    id: 'item-5',
    image: '/images/recap-images/Speaker frame (2).png',
    label: '3 Days of DevFest 2025 Card',
  },
  {
    id: 'item-6',
    image: '/images/recap-images/Speaker frame (3).png',
    label: 'Auditorium Stepped Seating Tech Session',
  },
  {
    id: 'item-7',
    image: '/images/recap-images/Speaker frame (4).png',
    label: 'Smiling Attendees Making Peace Sign',
  },
  {
    id: 'item-8',
    image: '/images/recap-images/Speaker frame (5).png',
    label: 'Celebration in Hall with Arms Spread',
  },
  {
    id: 'item-9',
    image: '/images/recap-images/Speaker frame (6).png',
    label: '15+ Sponsors & Partners Card',
  },
  {
    id: 'item-10',
    image: '/images/recap-images/Speaker frame (7).png',
    label: 'Ilorin Innovation Hub Entrance Sign',
  },
  {
    id: 'item-11',
    image: '/images/recap-images/Rectangle 34.png',
    label: 'Team Collaboration Around Laptop',
  },
  {
    id: 'item-12',
    image: '/images/recap-images/Speaker frame (8).png',
    label: '40+ Speakers Card',
  },
]
